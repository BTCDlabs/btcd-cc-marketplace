...
```
Why: Architecture knowledge not obvious from code.

### 4. Testing Approaches That Worked
```markdown
For API endpoints: Use `supertest` with test helper in `tests/setup.ts`
...
Bad: Multi-paragraph explanation of JWT.
...
> confusion about how to run the project.
