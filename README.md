...
|--------|---------|-------------|
| [claude-optimize](plugins/claude-optimize/) | 0.3.0 | Meta-plugin for recursive self-improvement of Claude Code environments. Provides 11 optimization modes for analyzing and improving your setup. |
